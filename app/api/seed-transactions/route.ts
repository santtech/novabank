...
const transactionsData = [
  ...
  { type: 'credit', amount: 3457.14, description: 'Freelance project payment' },
  { type: 'debit', amount: 1271.43, description: 'Electric and water bill' },
  { type: 'debit', amount: 35714.29, description: 'Netflix and Spotify subscriptions' },
  { type: 'credit', amount: 10000, description: 'Salary deposit - main job' },
  ...
  { type: 'debit', amount: 10000, description: 'Car insurance premium' },
  ...
  { type: 'credit', amount: 62571.43, description: 'Part-time job payment' },
  ...
  { type: 'credit', amount: 80000, description: 'Salary deposit from employer' },
  ...
  { type: 'credit', amount: 121428.57, description: 'Contract completion payment' },
  ...
  { type: 'credit', amount: 2507142.86, description: 'Dividend payout' },
  ...
  { type: 'credit', amount: 108571.43, description: 'Quarterly salary payment' },
