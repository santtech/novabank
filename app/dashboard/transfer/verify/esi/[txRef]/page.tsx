...
import { Loader2, Shield, ChevronLeft, CreditCard, Lock, Fingerprint } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#F4F6FA] p-4 md:p-6 pt-16 lg:pt-6">
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter italic">Security Verification</h1>
            <p className="text-sm md:text-base text-slate-400 font-bold uppercase tracking-widest opacity-60">Step 3 of 6: Access Check</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden">
            <div className="p-6 md:p-8 flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-1">
                <h2 className="text-2xl md:text-3xl font-black text-slate-900 uppercase tracking-tight italic">Security <span className="text-orange-600">Confirmation</span></h2>
                <p className="text-sm md:text-base text-slate-500 font-bold uppercase tracking-widest opacity-60 max-w-sm">
                  Enter your <span className="font-bold text-slate-700">Security Code (ESI)</span> to complete the identity verification phase.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="w-full space-y-6 pt-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="esiCode" className="text-[10px] md:text-xs font-black text-slate-500 uppercase tracking-widest">Security Code</Label>
                  <Input
                    id="esiCode"
                    type="text"
                    value={esiCode}
            ...
            <div className="bg-slate-50 p-4 border-t border-slate-100 flex items-center justify-center gap-2">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Enhanced security active</span>
            </div>
          </div>
        </motion.div>
